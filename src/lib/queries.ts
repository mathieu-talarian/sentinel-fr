...
const PRIOR_CONVOS: Array<PriorConvo> = [
  { id: 'c1', title: 'Wine import duty — 2023 vintage Bordeaux', when: 'Today' },
...
const CATALOG_STATS: CatalogStats = {
