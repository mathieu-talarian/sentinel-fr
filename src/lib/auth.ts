...
export function loadSessionHint(): Session | null {
...
export function persistSessionHint(s: Session | null) {
  try {
...
export async function signIn(args: SignInArgs): Promise<Session> {
